...
class Transaksi extends CI_Controller
{
	...
	{
		$data['transaksi'] = $this->db->query("SELECT * FROM tb_transaksi tr, tb_mobil mb, tb_costumer cs WHERE tr.id_mobil=mb.id_mobil AND tr.id_costumer = cs.id_costumer")->result();
	...
	public function transaksi_selesai_aksi()
	{
		...
		$tp 					= strtotime($tanggal_pengembalian);
		$tk 					= strtotime($tanggal_kembali);

		$selisih 				=abs($tp-$tk)/(60*60*24);

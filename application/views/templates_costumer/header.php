...
<head>
    ...
    <title>Ikhwan Car Rent Batam</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="index2.html" class="logo">
                            <h3 style="color:white;">Ikhwan Car Rent Batam</h3 style="color:white;">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li class=""><a href="<?php echo base_url('costumer/dashboard') ?>">Beranda</a></li>
                                <li><a href="<?php echo base_url('costumer/data_mobil') ?>">Mobil</a> </li>
                                <li><a href="<?php echo base_url('costumer/transaksi') ?>">Transaksi</a></li>

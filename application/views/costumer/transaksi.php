				...
				<?php $no=1; foreach($transaksi as $tr) : ?>
					...
					<tr>
						...
						<td>
							...
							<?php }else{ ?>
								<a href="<?php echo base_url('costumer/transaksi/pembayaran/'.$tr->id_rental) ?>" class="btn btn-sm btn-success">Cek Pembayaran</a>
						...
						<td>
							<?php 
								if($tr->status_rental == "Belum Selesai") { ?>
									<a onclick="return confirm('Apakah anda ingin membatalkan transaksi?')" class= "btn btn-sm btn-danger" href="<?php echo base_url('costumer/transaksi/batal_transaksi/'.$tr->id_rental) ?>">Batal</a>
								<?php }else{ ?>
